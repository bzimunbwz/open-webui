...
{#if $showSidebar}
	<div
		...
		class="h-screen max-h-[100dvh] min-h-screen select-none {$showSidebar
			? `${$mobile ? 'bg-gray-50 dark:bg-[#161616]' : 'bg-gray-50/70 dark:bg-[#161616]/70'} z-50`
		...
		>
			...
			>
				...
				<div
					class="{scrollTop > 0
						? 'visible'
						: 'invisible'} sidebar-bg-gradient-to-b bg-linear-to-b from-gray-50 dark:from-[#161616] to-transparent from-50% pointer-events-none absolute inset-0 -z-10 -mb-6"
				></div>
			</div>
			...
			>
				<div class="pb-1 mx-1.5 mt-1 mb-1.5 p-1 rounded-2xl bg-gray-100/70 dark:bg-white/[0.03]">
					<div class="px-[0.4375rem] flex justify-center text-gray-800 dark:text-gray-200">
						<a
							id="sidebar-new-chat-button"
							class="group grow flex items-center space-x-3 rounded-xl px-2.5 py-2 hover:bg-gray-100 dark:hover:bg-gray-900 transition outline-none {sbPath === '/' ? 'bg-black/5 dark:bg-[#212121]' : ''}\"
							href="/"
							draggable="false"
							on:click={newChatHandler}
							aria-label={$i18n.t('New Chat')}
					...
					<div class="px-[0.4375rem] flex justify-center text-gray-800 dark:text-gray-200">
						<button
							...
							class="group grow flex items-center space-x-3 rounded-xl px-2.5 py-2 hover:bg-gray-100 dark:hover:bg-gray-900 transition outline-none"
							on:click={() => {
								showSearch.set(true);
							}}
							draggable="false"
							...
							{#if meta && isMenuItemVisible(itemId)}
								...
								>
									<a
										...
										class="grow flex items-center space-x-3 rounded-xl px-2.5 py-2 hover:bg-gray-100 dark:hover:bg-gray-900 transition {sbPath === meta.href ? 'bg-black/5 dark:bg-[#212121]' : ''}\"
										href={meta.href}
			...
			<div class="px-1.5 pt-1.5 pb-2 sticky bottom-0 z-10 -mt-3 sidebar">
				<div
					class=" sidebar-bg-gradient-to-t bg-linear-to-t from-gray-50 dark:from-[#161616] to-transparent from-50% pointer-events-none absolute inset-0 -z-10 -mt-6"
				></div>
