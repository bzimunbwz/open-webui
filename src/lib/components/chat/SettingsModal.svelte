	...
	<div class="text-gray-700 dark:text-gray-100 mx-1">
		...
		<div class="flex flex-col md:flex-row w-full pt-1 pb-4">
			<div
				...
				class="tabs flex flex-row overflow-x-auto gap-2.5 mx-3 md:pr-4 md:gap-0.5 md:flex-col flex-1 md:flex-none md:w-52 md:min-h-[min(42rem,calc(100dvh-10rem))] md:max-h-[min(42rem,calc(100dvh-10rem))] dark:text-gray-200 text-sm text-left mb-1 md:mb-0 -translate-y-1"
			>
				<div
			...
			<div
				class="flex-1 px-3.5 md:pl-4 md:pr-4.5 md:border-l dark:border-white/[0.06] md:min-h-[min(42rem,calc(100dvh-10rem))] max-h-[min(42rem,calc(100dvh-10rem))] overflow-y-auto"
			>
