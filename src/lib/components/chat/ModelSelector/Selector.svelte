...
<div class="relative w-full">
	...
	>
		<div
			class="flex items-center gap-2 max-w-full text-left truncate rounded-lg border border-gray-200 dark:border-[#ffffff1a] bg-gray-50 dark:bg-[#1a1a1a] hover:bg-gray-100 dark:hover:bg-[#242424] transition px-3 py-1.5 {triggerClassName} {($settings?.highContrastMode ??
			false)
