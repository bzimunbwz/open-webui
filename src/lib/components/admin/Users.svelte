...
<div class="flex flex-col lg:flex-row w-full h-full pb-2 lg:space-x-4">
	...
	>
		<a
			...
			draggable="false"
			class="group flex items-center gap-2.5 px-3 py-2 rounded-xl min-w-fit transition select-none whitespace-nowrap {selectedTab === 'overview'
		...
		<a
			...
			draggable="false"
			class="group flex items-center gap-2.5 px-3 py-2 rounded-xl min-w-fit transition select-none whitespace-nowrap {selectedTab === 'groups'
			? 'bg-[#d4a574]/15 text-gray-900 dark:text-white font-semibold'
			: 'text-gray-500 dark:text-gray-400 hover:bg-black/5 dark:hover:bg-white/5 hover:text-gray-800 dark:hover:text-gray-200'}"
		>
			<div class="self-center">
