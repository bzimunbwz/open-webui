...
USER_PERMISSIONS_CHAT_COPY = os.getenv('USER_PERMISSIONS_CHAT_COPY', 'True').lower() == 'true'

USER_PERMISSIONS_CHAT_MESSAGE_INFO = os.getenv('USER_PERMISSIONS_CHAT_MESSAGE_INFO', 'True').lower() == 'true'
...
DEFAULT_USER_PERMISSIONS = {
    ...
    'chat': {
        ...
        'copy': USER_PERMISSIONS_CHAT_COPY,
        'message_info': USER_PERMISSIONS_CHAT_MESSAGE_INFO,
